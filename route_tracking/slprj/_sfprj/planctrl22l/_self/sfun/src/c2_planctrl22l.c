...
static const char * c2_debug_family_names[14] = { "k", "p", "L", "psi_d", "dpsi",
  "nargin", "nargout", "x", "y", "psi", "slast", "u", "s", "pfnext" };

static const char * c2_b_debug_family_names[9] = { "R", "Ocenter", "theta",
  "pfx", "pfy", "nargin", "nargout", "s", "pf" };

static const char * c2_c_debug_family_names[14] = { "uppererror", "ssample",
  "delta", "dislast", "slast", "dis", "deltas", "nargin", "nargout", "L", "p",
  "sinput", "pf", "s" };

/* Function Declarations */
static void initialize_c2_planctrl22l(SFc2_planctrl22lInstanceStruct
  *chartInstance);
static void initialize_params_c2_planctrl22l(SFc2_planctrl22lInstanceStruct
  *chartInstance);
static void enable_c2_planctrl22l(SFc2_planctrl22lInstanceStruct *chartInstance);
static void disable_c2_planctrl22l(SFc2_planctrl22lInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_planctrl22l
  (SFc2_planctrl22lInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_planctrl22l
  (SFc2_planctrl22lInstanceStruct *chartInstance);
static void set_sim_state_c2_planctrl22l(SFc2_planctrl22lInstanceStruct
  *chartInstance, const mxArray *c2_st);
static void finalize_c2_planctrl22l(SFc2_planctrl22lInstanceStruct
  *chartInstance);
static void sf_gateway_c2_planctrl22l(SFc2_planctrl22lInstanceStruct
  *chartInstance);
static void mdl_start_c2_planctrl22l(SFc2_planctrl22lInstanceStruct
  *chartInstance);
static void c2_chartstep_c2_planctrl22l(SFc2_planctrl22lInstanceStruct
  *chartInstance);
static void initSimStructsc2_planctrl22l(SFc2_planctrl22lInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber, uint32_T c2_instanceNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static void c2_emlrt_marshallIn(SFc2_planctrl22lInstanceStruct *chartInstance,
  const mxArray *c2_b_pfnext, const char_T *c2_identifier, real_T c2_b_y[2]);
static void c2_b_emlrt_marshallIn(SFc2_planctrl22lInstanceStruct *chartInstance,
  const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_b_y[2]);
static void c2_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_c_emlrt_marshallIn(SFc2_planctrl22lInstanceStruct
  *chartInstance, const mxArray *c2_b_s, const char_T *c2_identifier);
static real_T c2_d_emlrt_marshallIn(SFc2_planctrl22lInstanceStruct
...
static void c2_curvefun(SFc2_planctrl22lInstanceStruct *chartInstance, real_T
  c2_b_s, real_T c2_pf[2]);
static real_T c2_eml_xnrm2(SFc2_planctrl22lInstanceStruct *chartInstance, real_T
  c2_b_x[2]);
static void c2_below_threshold(SFc2_planctrl22lInstanceStruct *chartInstance);
static const mxArray *c2_c_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_e_emlrt_marshallIn(SFc2_planctrl22lInstanceStruct
  *chartInstance, const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_f_emlrt_marshallIn(SFc2_planctrl22lInstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_planctrl22l, const char_T
  *c2_identifier);
static uint8_T c2_g_emlrt_marshallIn(SFc2_planctrl22lInstanceStruct
  *chartInstance, const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_planctrl22lInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc2_planctrl22lInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_planctrl22l = 0U;
}
  ...
  (SFc2_planctrl22lInstanceStruct *chartInstance)
{
  ...
  for (c2_i0 = 0; c2_i0 < 2; c2_i0++) {
    c2_b_u[c2_i0] = (*chartInstance->c2_pfnext)[c2_i0];
  }

  c2_c_y = NULL;
  sf_mex_assign(&c2_c_y, sf_mex_create("y", c2_b_u, 0, 0U, 1U, 0U, 2, 1, 2),
                false);
  sf_mex_setcell(c2_b_y, 0, c2_c_y);
  c2_hoistedGlobal = *chartInstance->c2_s;
  c2_c_u = c2_hoistedGlobal;
  c2_d_y = NULL;
  sf_mex_assign(&c2_d_y, sf_mex_create("y", &c2_c_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c2_b_y, 1, c2_d_y);
  c2_b_hoistedGlobal = *chartInstance->c2_u;
  c2_d_u = c2_b_hoistedGlobal;
  c2_e_y = NULL;
  sf_mex_assign(&c2_e_y, sf_mex_create("y", &c2_d_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c2_b_y, 2, c2_e_y);
  c2_c_hoistedGlobal = chartInstance->c2_is_active_c2_planctrl22l;
  ...
  *chartInstance, const mxArray *c2_st)
{
  ...
  for (c2_i1 = 0; c2_i1 < 2; c2_i1++) {
    (*chartInstance->c2_pfnext)[c2_i1] = c2_dv0[c2_i1];
  }

  *chartInstance->c2_s = c2_c_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c2_b_u, 1)), "s");
  *chartInstance->c2_u = c2_c_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c2_b_u, 2)), "u");
  chartInstance->c2_is_active_c2_planctrl22l = c2_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_b_u, 3)),
     "is_active_c2_planctrl22l");
  sf_mex_destroy(&c2_b_u);
  c2_update_debugger_state_c2_planctrl22l(chartInstance);
  ...
  *chartInstance)
{
  ...
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_x, 0U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_y, 1U);
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_planctrl22l(chartInstance);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_planctrl22lMachineNumber_,
    chartInstance->chartNumber, chartInstance->instanceNumber);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_u, 2U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_psi, 3U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_slast, 4U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_s, 5U);
  for (c2_i2 = 0; c2_i2 < 2; c2_i2++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c2_pfnext)[c2_i2], 6U);
  }
}
  ...
  *chartInstance)
{
  ...
  real_T c2_b_u;
  real_T c2_b_s;
  real_T c2_b_pfnext[2];
  real_T c2_b_L;
  int32_T c2_i3;
  real_T c2_b_p[2];
  real_T c2_sinput;
  real_T c2_uppererror;
  real_T c2_ssample;
  real_T c2_delta;
  real_T c2_dislast;
  real_T c2_c_slast;
  ...
  c2_d_hoistedGlobal = *chartInstance->c2_slast;
  c2_b_x = c2_hoistedGlobal;
  c2_b_y = c2_b_hoistedGlobal;
  c2_b_psi = c2_c_hoistedGlobal;
  c2_b_slast = c2_d_hoistedGlobal;
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 14U, 14U, c2_debug_family_names,
    c2_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_k, 0U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_p, 1U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_L, 2U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_psi_d, 3U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_dpsi, 4U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_nargout, 6U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_b_x, 7U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_b_y, 8U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_b_psi, 9U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_b_slast, 10U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_b_u, 11U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_b_s, 12U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_b_pfnext, 13U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  for (c2_i3 = 0; c2_i3 < 2; c2_i3++) {
    c2_b_p[c2_i3] = c2_p[c2_i3];
  }

  c2_sinput = c2_b_slast;
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 14U, 14U, c2_c_debug_family_names,
    c2_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_uppererror, 0U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_ssample, 1U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_delta, 2U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_dislast, 3U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_c_slast, 4U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_dis, 5U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_deltas, 6U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_b_nargin, 7U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_b_nargout, 8U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_b_L, 9U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_b_p, 10U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_sinput, 11U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_c_pfnext, 12U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_c_s, 13U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  CV_EML_FCN(0, 2);
  ...
  c2_curvefun(chartInstance, c2_sinput, c2_c_x);
  for (c2_i4 = 0; c2_i4 < 2; c2_i4++) {
    c2_c_x[c2_i4] -= c2_b_p[c2_i4];
  }

  for (c2_i5 = 0; c2_i5 < 2; c2_i5++) {
    c2_d_x[c2_i5] = c2_c_x[c2_i5];
  }

  c2_c_y = c2_eml_xnrm2(chartInstance, c2_d_x);
  c2_d0 = c2_c_y - c2_b_L;
  if (CV_EML_IF(0, 1, 2, CV_RELATIONAL_EVAL(4U, 0U, 2, c2_d0, 0.1 * c2_b_L, -1,
        4U, c2_d0 > 0.1 * c2_b_L))) {
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 71);
    c2_curvefun(chartInstance, c2_sinput, c2_dv1);
    for (c2_i6 = 0; c2_i6 < 2; c2_i6++) {
      c2_c_pfnext[c2_i6] = c2_dv1[c2_i6];
    }
    ...
    c2_c_slast = c2_sinput;
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 75);
    c2_c_s = c2_c_slast + c2_ssample;
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 76);
    c2_curvefun(chartInstance, c2_c_s, c2_dv2);
    for (c2_i7 = 0; c2_i7 < 2; c2_i7++) {
      c2_c_pfnext[c2_i7] = c2_dv2[c2_i7];
    }

    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 77);
    for (c2_i8 = 0; c2_i8 < 2; c2_i8++) {
      c2_c_x[c2_i8] = c2_c_pfnext[c2_i8] - c2_b_p[c2_i8];
    }

    for (c2_i9 = 0; c2_i9 < 2; c2_i9++) {
      c2_e_x[c2_i9] = c2_c_x[c2_i9];
    }

    c2_dis = c2_eml_xnrm2(chartInstance, c2_e_x);
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 78);
    c2_deltas = c2_c_s - c2_sinput;
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 80);
    do {
      exitg1 = 0;
      c2_f_x = c2_dis - c2_b_L;
      c2_g_x = c2_f_x;
      c2_d_y = muDoubleScalarAbs(c2_g_x);
      if (c2_d_y > c2_uppererror) {
        if (c2_deltas < c2_delta) {
          CV_EML_WHILE(0, 1, 0, true);
          _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 81);
          c2_c_s = c2_c_slast + c2_ssample;
          _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 82);
          c2_curvefun(chartInstance, c2_c_s, c2_dv3);
          for (c2_i10 = 0; c2_i10 < 2; c2_i10++) {
            c2_c_pfnext[c2_i10] = c2_dv3[c2_i10];
          }

          _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 83);
          for (c2_i11 = 0; c2_i11 < 2; c2_i11++) {
            c2_c_x[c2_i11] = c2_c_pfnext[c2_i11] - c2_b_p[c2_i11];
          }

          for (c2_i12 = 0; c2_i12 < 2; c2_i12++) {
            c2_h_x[c2_i12] = c2_c_x[c2_i12];
          }

          c2_dis = c2_eml_xnrm2(chartInstance, c2_h_x);
          _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 84);
          if (CV_EML_IF(0, 1, 3, CV_RELATIONAL_EVAL(4U, 0U, 3, (c2_dis - c2_b_L)
                * (c2_dislast - c2_b_L), 0.0, -1, 2U, (c2_dis - c2_b_L) *
                (c2_dislast - c2_b_L) < 0.0))) {
  ...
  for (c2_i13 = 0; c2_i13 < 2; c2_i13++) {
    c2_b_pfnext[c2_i13] = c2_c_pfnext[c2_i13];
  }

  c2_b_s = c2_c_s;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 34);
  c2_e_y = c2_b_pfnext[1] - c2_b_y;
  c2_i_x = c2_b_pfnext[0] - c2_b_x;
  c2_f_y = c2_e_y;
  c2_j_x = c2_i_x;
  c2_psi_d = muDoubleScalarAtan2(c2_f_y, c2_j_x);
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 35);
  c2_dpsi = c2_psi_d - c2_b_psi;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 36);
  if (CV_EML_IF(0, 1, 0, CV_RELATIONAL_EVAL(4U, 0U, 0, c2_dpsi,
        3.1415926535897931, -1, 4U, c2_dpsi > 3.1415926535897931))) {
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 37);
    c2_dpsi -= 6.2831853071795862;
  } else {
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 38);
    if (CV_EML_IF(0, 1, 1, CV_RELATIONAL_EVAL(4U, 0U, 1, c2_dpsi,
          -3.1415926535897931, -1, 2U, c2_dpsi < -3.1415926535897931))) {
  ...
  *chartInstance->c2_s = c2_b_s;
  for (c2_i14 = 0; c2_i14 < 2; c2_i14++) {
    (*chartInstance->c2_pfnext)[c2_i14] = c2_b_pfnext[c2_i14];
  }
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_b_y = NULL;
  SFc2_planctrl22lInstanceStruct *chartInstance;
  chartInstance = (SFc2_planctrl22lInstanceStruct *)chartInstanceVoid;
  ...
  for (c2_i16 = 0; c2_i16 < 2; c2_i16++) {
    c2_b_u[c2_i16] = c2_b_inData[c2_i16];
  }
  ...
  const mxArray *c2_b_pfnext, const char_T *c2_identifier, real_T c2_b_y[2])
{
  ...
  c2_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c2_b_pfnext), &c2_thisId,
                        c2_b_y);
  sf_mex_destroy(&c2_b_pfnext);
}
  ...
  const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_b_y[2])
{
  ...
  int32_T c2_i17;
  (void)chartInstance;
  sf_mex_import(c2_parentId, sf_mex_dup(c2_b_u), c2_dv4, 1, 0, 0U, 1, 0U, 2, 1,
                2);
  for (c2_i17 = 0; c2_i17 < 2; c2_i17++) {
    c2_b_y[c2_i17] = c2_dv4[c2_i17];
  }
  ...
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData)
{
  ...
  SFc2_planctrl22lInstanceStruct *chartInstance;
  chartInstance = (SFc2_planctrl22lInstanceStruct *)chartInstanceVoid;
  c2_b_pfnext = sf_mex_dup(c2_mxArrayInData);
  ...
  for (c2_i18 = 0; c2_i18 < 2; c2_i18++) {
    (*(real_T (*)[2])c2_outData)[c2_i18] = c2_b_y[c2_i18];
  }
  ...
  *chartInstance, const mxArray *c2_b_s, const char_T *c2_identifier)
{
  ...
  c2_thisId.fIdentifier = c2_identifier;
  c2_thisId.fParent = NULL;
  c2_b_y = c2_d_emlrt_marshallIn(chartInstance, sf_mex_dup(c2_b_s), &c2_thisId);
...
static void c2_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData)
{
  const mxArray *c2_b_s;
  const char_T *c2_identifier;
  emlrtMsgIdentifier c2_thisId;
  real_T c2_b_y;
  SFc2_planctrl22lInstanceStruct *chartInstance;
  chartInstance = (SFc2_planctrl22lInstanceStruct *)chartInstanceVoid;
  c2_b_s = sf_mex_dup(c2_mxArrayInData);
  c2_identifier = c2_varName;
  c2_thisId.fIdentifier = c2_identifier;
  c2_thisId.fParent = NULL;
  c2_b_y = c2_d_emlrt_marshallIn(chartInstance, sf_mex_dup(c2_b_s), &c2_thisId);
...
const mxArray *sf_c2_planctrl22l_get_eml_resolved_functions_info(void)
{
...
static void c2_info_helper(const mxArray **c2_info)
{
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/cos.m"), "resolved",
                  "resolved", 7);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1395303296U), "fileTimeLo",
                  "fileTimeLo", 7);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 7);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/sin.m"), "resolved",
                  "resolved", 9);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1395303304U), "fileTimeLo",
                  "fileTimeLo", 9);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 9);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("norm"), "name", "name", 11);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 11);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1375959092U), "fileTimeLo",
                  "fileTimeLo", 14);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 14);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/+refblas/xnrm2.p"),
                  "context", "context", 21);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("realmin"), "name", "name", 21);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 21);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1372561560U), "fileTimeLo",
                  "fileTimeLo", 24);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 24);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1397235822U), "fileTimeLo",
                  "fileTimeLo", 27);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 27);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/fixedpoint/isfi.m"), "resolved",
                  "resolved", 28);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1346488758U), "fileTimeLo",
                  "fileTimeLo", 28);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 28);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/fixedpoint/isnumerictype.m"), "resolved",
                  "resolved", 29);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1398853998U), "fileTimeLo",
                  "fileTimeLo", 29);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 29);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/+refblas/xnrm2.p"),
                  "context", "context", 34);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("abs"), "name", "name", 34);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 34);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("atan2"), "name", "name", 38);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 38);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  c2_b_s, real_T c2_pf[2])
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_Ocenter, 1U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_theta, 2U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_pfx, 3U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_pfy, 4U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_nargin, 5U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_nargout, 6U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_b_s, 7U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_pf, 8U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  CV_EML_FCN(0, 1);
  ...
  *chartInstance, const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId)
{
  ...
  int32_T c2_i20;
  (void)chartInstance;
  sf_mex_import(c2_parentId, sf_mex_dup(c2_b_u), &c2_i20, 1, 6, 0U, 0, 0U, 0);
  c2_b_y = c2_i20;
  sf_mex_destroy(&c2_b_u);
  return c2_b_y;
}
  ...
  *c2_identifier)
{
  ...
  c2_b_y = c2_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_planctrl22l), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_planctrl22l);
  return c2_b_y;
}
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_psi = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 2);
  chartInstance->c2_slast = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 3);
  chartInstance->c2_s = (real_T *)ssGetOutputPortSignal_wrapper(chartInstance->S,
    2);
  chartInstance->c2_pfnext = (real_T (*)[2])ssGetOutputPortSignal_wrapper
    (chartInstance->S, 3);
}
...
void sf_c2_planctrl22l_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2033249163U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(102225849U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3065583504U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(79808669U);
}

mxArray* sf_c2_planctrl22l_get_post_codegen_info(void);
mxArray *sf_c2_planctrl22l_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("MT6XWtsZELYfXTnF5vqjvB");
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c2_planctrl22l_get_post_codegen_info();
...
mxArray *sf_c2_planctrl22l_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_planctrl22l_jit_fallback_info(void)
{
...
mxArray *sf_c2_planctrl22l_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c2_planctrl22l(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[17],T\"pfnext\",},{M[1],M[16],T\"s\",},{M[1],M[7],T\"u\",},{M[8],M[0],T\"is_active_c2_planctrl22l\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_planctrl22l_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc2_planctrl22lInstanceStruct *) chartInfo->chartInstance;
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(2,2,0,1,"u");
          _SFD_SET_DATA_PROPS(3,1,1,0,"psi");
          _SFD_SET_DATA_PROPS(4,1,1,0,"slast");
          _SFD_SET_DATA_PROPS(5,2,0,1,"s");
          _SFD_SET_DATA_PROPS(6,2,0,1,"pfnext");
        ...
        _SFD_CV_INIT_EML(0,1,3,4,0,0,0,0,1,0,0);
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,633);
        _SFD_CV_INIT_EML_FCN(0,1,"curvefun",633,-1,995);
        _SFD_CV_INIT_EML_FCN(0,2,"getnextposition",996,-1,1677);
        _SFD_CV_INIT_EML_IF(0,1,0,550,560,581,596);
        _SFD_CV_INIT_EML_IF(0,1,1,581,596,-1,596);
        _SFD_CV_INIT_EML_IF(0,1,2,1119,1155,1206,1676);
        _SFD_CV_INIT_EML_IF(0,1,3,1495,1519,-1,1575);
        _SFD_CV_INIT_EML_WHILE(0,1,0,1350,1394,1666);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,0,553,560,-1,4);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,1,588,596,-1,2);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,2,1122,1154,-1,4);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,3,1498,1519,-1,2);
        ...
        _SFD_SET_DATA_VALUE_PTR(2U, chartInstance->c2_u);
        _SFD_SET_DATA_VALUE_PTR(3U, chartInstance->c2_psi);
        _SFD_SET_DATA_VALUE_PTR(4U, chartInstance->c2_slast);
        _SFD_SET_DATA_VALUE_PTR(5U, chartInstance->c2_s);
        _SFD_SET_DATA_VALUE_PTR(6U, *chartInstance->c2_pfnext);
      }
    } else {
...
{
  return "aPmFnyVaWphOW68pcUsQ";
}

static void sf_opaque_initialize_c2_planctrl22l(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_planctrl22lInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c2_planctrl22l((SFc2_planctrl22lInstanceStruct*)
    chartInstanceVar);
  initialize_c2_planctrl22l((SFc2_planctrl22lInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_planctrl22l(void *chartInstanceVar)
{
  enable_c2_planctrl22l((SFc2_planctrl22lInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_planctrl22l(void *chartInstanceVar)
{
  disable_c2_planctrl22l((SFc2_planctrl22lInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_planctrl22l(void *chartInstanceVar)
{
  sf_gateway_c2_planctrl22l((SFc2_planctrl22lInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c2_planctrl22l(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c2_planctrl22l((SFc2_planctrl22lInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c2_planctrl22l(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c2_planctrl22l((SFc2_planctrl22lInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c2_planctrl22l(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_planctrl22lInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c2_planctrl22l((SFc2_planctrl22lInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_planctrl22l((SFc2_planctrl22lInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_planctrl22l(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_planctrl22l(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(3881946749U));
  ssSetChecksum1(S,(1337661356U));
  ssSetChecksum2(S,(3315108879U));
  ssSetChecksum3(S,(2072020176U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c2_planctrl22l(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_planctrl22l(SimStruct *S)
{
  SFc2_planctrl22lInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc2_planctrl22lInstanceStruct *)utMalloc(sizeof
    (SFc2_planctrl22lInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_planctrl22lInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c2_planctrl22l;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c2_planctrl22l;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c2_planctrl22l;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_planctrl22l;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_planctrl22l;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c2_planctrl22l;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c2_planctrl22l;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_planctrl22l;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_planctrl22l;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_planctrl22l;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c2_planctrl22l;
...
void c2_planctrl22l_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_planctrl22l(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_planctrl22l(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_planctrl22l(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_planctrl22l_method_dispatcher.\n"
