...
%% communication 
    ...
    udpReceiver1 = udp('','LocalPort',portUAV2);
...
%communication
    ...
    fwrite(udpSender,send_data,'float')
     ...
     X1rec(1,mpciter)=rec_1(1);
     Y1rec(1,mpciter)=rec_1(2);
     end
     ...
     X1rec(2,mpciter)=rec_2(1);
     Y1rec(2,mpciter)=rec_2(2);
     end
     ...
     X1rec(3,mpciter)=rec_3(1);
     Y1rec(3,mpciter)=rec_3(2);
     end
...
save('D:\05.Code\data_analysis\four_UAV_test\rectangle0912_1_uav1.mat','X1','Y1', 'PSI1', 'XC1','YC1','PSIF1', 'JVALUE1','UCON1', 'FLAG1', 'Dis1', 'COOPCost1', 'X1rec', 'Y1rec' );
%% Plot 
figure
